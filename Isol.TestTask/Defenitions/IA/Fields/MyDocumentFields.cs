...
namespace Isol.TestTask.Defenitions.IA.Fields
{
    public static class MyDocumentFields
    {
        public static TaxonomyFieldDefinition DocumentType = new TaxonomyFieldDefinition()
        {
            ...
            InternalName = Const.InternalPrefixes.ProjectDocument + Const.FieldNames.ProjectDocumentFields.DocumentType.Trim(),
        ...
        public static FieldDefinition ExpirationDate = new FieldDefinition
        {
            ...
            InternalName = Const.InternalPrefixes.ProjectDocument + Const.FieldNames.ProjectDocumentFields.ExpirationDate.Trim(),
            Group = Const.Groups.DefaultFieldsGroup,
        ...
        public static FieldDefinition BelongToProject = new LookupFieldDefinition()
        {
            ...
            InternalName = Const.InternalPrefixes.ProjectDocument + Const.FieldNames.ProjectDocumentFields.BelongToProject.Trim(),
            Group = Const.Groups.DefaultFieldsGroup,
        ...
        public static FieldDefinition DocumentResponsible = new FieldDefinition
        {
            ...
            InternalName = Const.InternalPrefixes.ProjectDocument + Const.FieldNames.ProjectDocumentFields.DocumentResponsible.Trim(),
            Group = Const.Groups.DefaultFieldsGroup,
